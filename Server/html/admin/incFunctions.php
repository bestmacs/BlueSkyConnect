	...
	*/
		...
		$all_tables = [
			/* ['table_name' => [table props assoc array] */   
				...
				'global' => [
					...
					'Description' => 'Set global options for all BlueSky installs or the server.',
					'tableIcon' => 'table.gif',
					'group' => $tg[0],
					'homepageShowCount' => 0
				],
				'connections' => [
					...
					'Description' => 'Tracks admin connection activity',
					'tableIcon' => 'table.gif',
					'group' => $tg[0],
					'homepageShowCount' => 0
				],
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'computers' => ['BlueSky Admin', '', 'table.gif', 'None'],
			'global' => ['Global Settings', 'Set global options for all BlueSky installs or the server.', 'table.gif', 'None'],
			'connections' => ['Connection Log', 'Tracks admin connection activity', 'table.gif', 'None'],
		];
		...
		if($schema === null) {
			...
			$schema = [
				'computers' => [
					...
					'blueskyid' => [
						'appgini' => "SMALLINT NOT NULL UNIQUE",
						'info' => [
							'caption' => 'BlueSky ID',
							'description' => 'This is the ID number that you will use to reach this computer over BlueSky.  This number is required, must be unique, and must be less than 2000.  Computer will not use new port number until its connection is restarted.',
						],
					],
					'serialnum' => [
						...
						'info' => [
							...
							'description' => 'This computer\'s hardware serial number.  We use this for identification.  If the logic board was not given a serial number on replacement, we will generate a code to use.',
						],
					],
					'hostname' => [
						...
						'info' => [
							'caption' => 'Name',
							'description' => 'This is an idenitifer that you can modify.  We will prepopulate with the same info from the Sharing Name below.',
						],
					],
					'sshlink' => [
						'appgini' => "TEXT NULL",
						'info' => [
							'caption' => 'SSH',
							'description' => 'Click here to open BlueSky Admin Connect and initiate a remote shell to this computer.',
						],
					],
					'vnclink' => [
						'appgini' => "TEXT NULL",
						'info' => [
							'caption' => 'VNC',
							'description' => 'Click here to open BlueSky Admin Connect and initiate a remote shell and ScreenSharing to this computer.',
						],
					],
					'scplink' => [
						'appgini' => "TEXT NULL",
						'info' => [
							'caption' => 'SCP',
							'description' => 'Click here to open BlueSky Admin Connect and initiate a file or folder upload to /tmp on this computer.',
						],
					],
					'username' => [
						...
						'info' => [
							'caption' => 'UserName',
							'description' => 'This is the user name that will be used when clicking connect links.  If left blank, you will be asked on connection.  If you would like this to always be the same name across all of your BlueSky computers, contact Mac-MSP support.',
						],
					],
					'sharingname' => [
						'appgini' => "VARCHAR(250) NULL",
						'info' => [
							'caption' => 'Sharing Name',
							'description' => 'The name from Sharing.prefpane that will update occasionally (during re-key sequences). If Watchman Monitoring is installed, we will also prepend the client group.',
						],
					],
					'gruntwork' => [
						'appgini' => "TEXT NULL",
						'info' => [
							'caption' => 'Gruntwork Link',
							'description' => 'If you are also a Gruntwork subscriber, this link will take you this computer in the Gruntwork UI.',
						],
					],
					'datetime' => [
					...
					'status' => [
						'appgini' => "VARCHAR(253) NULL",
						'info' => [
							'caption' => 'Status',
							'description' => 'This shows the last time the computer contacted the BlueSky server',
						],
					],
					'registered' => [
						'appgini' => "VARCHAR(40) NULL",
						'info' => [
							...
							'description' => 'This is the date and time when this computer most recently registered with the BlueSky server.',
						],
					],
					'notify' => [
						...
						'info' => [
							'caption' => 'Notify',
							'description' => 'Next time this computer checks in with the server, you will receive an email and this box will uncheck.',
						],
					],
					'alert' => [
						'appgini' => "TINYINT NULL",
						'info' => [
							'caption' => 'Alert',
							'description' => 'If this computer does not check-in over a 15 minute span, we will mark it down and send you an email.  You\'ll also recieve an email when it comes back up.',
						],
					],
					'email' => [
						'appgini' => "VARCHAR(253) NULL",
						'info' => [
							'caption' => 'Email Address to Notify',
							'description' => 'Send to this email address when either the "notify" or "alert" boxes are checked.  If left blank we will default to the email address you registered with.  Contact support if you\'d like that changed.',
						],
					],
					'notes' => [
						'appgini' => "TEXT NULL",
						'info' => [
							'caption' => 'Notes',
							'description' => 'A place for any random notes you might like to keep.',
						],
					],
					'selfdestruct' => [
						'appgini' => "TINYINT NULL",
						'info' => [
							'caption' => 'Remove BlueSky (Cannot Undo From Here)',
							'description' => 'Checking this box will remotely remove BleuSky on its next check-in.  Once that is done, it will no longer check-in.',
						],
					],
					'downup' => [
						'appgini' => "TINYINT NULL",
					...
					'timestamp' => [
						...
						'info' => [
							'caption' => 'Timestamp',
							'description' => 'epoch set when we are able to connect over SSH',
						],
					],
				],
				'global' => [
					...
					'defaultemail' => [
						'appgini' => "VARCHAR(250) NULL",
						'info' => [
							'caption' => 'Default Admin Email',
							'description' => 'When BlueSky generates an email report, send it to this address by default.',
						],
					],
					'adminkeys' => [
						'appgini' => "TEXT NULL",
						'info' => [
							'caption' => 'Admin Keys',
							'description' => 'These are the identifiers for the installed admin keys.',
						],
					],
					'clickhere' => [
						'appgini' => "VARCHAR(40) NULL",
					...
					'updateNames' => [
						...
						'info' => [
							'caption' => 'Update Host Names',
							'description' => 'Set names in BlueSky to dynamically match names set in Sharing.prefpane',
						],
					],
				],
				'connections' => [
