<?php
	...
	$transformFunctions = [
		'computers' => function($data, $options = []) {

			return $data;
		},
		'global' => function($data, $options = []) {

			return $data;
		},
		'connections' => function($data, $options = []) {
	...
	$filterFunctions = [
		'computers' => function($data, $options = []) { return true; },
		'global' => function($data, $options = []) { return true; },
		'connections' => function($data, $options = []) { return true; },
	];
